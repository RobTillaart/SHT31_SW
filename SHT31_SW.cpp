...
void SHT31_SW::setHeatTimeout(uint8_t seconds)
{
...
bool SHT31_SW::dataReady()
{
  return ((millis() - _lastRequest) > 15);  //  TODO MAGIC NR
}


bool SHT31_SW::readData(bool fast)
{
  uint8_t buffer[6];
...
//  PRIVATE
//
uint8_t SHT31_SW::crc8(const uint8_t *data, uint8_t len) 
{
